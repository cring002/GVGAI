...
public class MCTHandler extends SubAgent {
	...
	public MCTHandler(YoloState rootState) {
		...
		heuristics.SetWeight(HeuristicType.ScoreHeuristic, scoreWeight);
		...
		heuristics.Put(winH);
		heuristics.SetWeight(HeuristicType.WinHeuristic, winWeight);
			

		heuristics.Put(aSDH);
		heuristics.SetWeight(HeuristicType.AStarDistantsHeuristic,
				rootState.isOneDimensionGame() ? 0 : distanceWeight);

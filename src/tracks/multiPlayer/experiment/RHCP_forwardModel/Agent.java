...
public class Agent extends AbstractMultiPlayer {
    ...
    public static int predictionCount; //how many predictions per game
    public static int correctPredictionCount; // how many times it predicted correctly
    ...
    public Types.ACTIONS act(StateObservationMulti stateObs, ElapsedCpuTimer elapsedTimer) {
        ...
        if(!firstIteration) {
            ...
            if (opActualMove == predictedMoveAc){
